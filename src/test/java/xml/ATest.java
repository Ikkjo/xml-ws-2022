...
public class ATest {
    ...
    public static void test(String testFilePath) {
        ...
        try {
            ...
            // Promeni vrednosti
            request.getInformationForInstitution().setRequestNumber("A-1337");
    ...
    private static void printRequest(CopyrightSubmissionRequest request) {
        ...
        System.out.printf(
                ...
                request.getInformationForInstitution().getRequestNumber(),
                request.getInformationForInstitution().getRequestSubmissionDate()
        );
