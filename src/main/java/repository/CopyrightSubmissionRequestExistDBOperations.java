...
import util.ExistDBAuthUtils;
import util.ExistDBAuthUtils.ConnectionProperties;
...
public class CopyrightSubmissionRequestExistDBOperations {
    ...
    public boolean save(CopyrightSubmissionRequest request) throws Exception {
        ...
        String documentId =  request.getInformationForInstitution().getRequestNumber() + ".xml";
